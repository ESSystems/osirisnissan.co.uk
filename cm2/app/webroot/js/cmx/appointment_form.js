(function() {
	var originalDateRangeRender = Ext.ensible.cal.DateRangeField.prototype.onRender;
	...
	Ext.override(Ext.ensible.cal.DateRangeField, {
		...
		// onRender: function() {
		// 	originalDateRangeRender.apply(this, arguments);
		// 	Ext.getCmp(this.id+'-end-time').setReadOnly(true);
		// 	Ext.getCmp(this.id+'-end-date').setReadOnly(true);
		// },
		// private
	...
	Ext.override(Ext.ensible.cal.EventEditWindow, {
		...
		onRender: function() {
			...
			this.dateRangeField.showAllDay = false;
			this.calendarField.hide();
			this.getFooterToolbar().remove(this.getFooterToolbar().getComponent(2)); // remove delete
		}
	});
})();